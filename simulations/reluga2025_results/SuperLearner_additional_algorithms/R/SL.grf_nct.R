...
#' 
SL.grf_nct <- function(Y, X, newX, family, obsWeights, model = FALSE, ...) {
  ...
  fit <- regression_forest(X, Y, tune.parameters = "all")
...
#'
#' @export
predict.SL.grf_nct <- function(object, newdata, ...) {
