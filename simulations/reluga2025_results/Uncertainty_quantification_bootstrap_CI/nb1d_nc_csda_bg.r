...
# model_formula_OR_f <- y ~ X1 + X2 + X3 + X4 + X5 + X6 + X7 + X8 + X9 + X10 + X11 + A+ (1 + A|group)
# 
...
#  ps_hat_X = c(data_sample_ps$ps_hat_X, data_out_of_sample_ps$ps_hat_X)
  ...
  y_full_imputed <- y_full_imputedM[b, ]
...
# par(mfrow = c(1, 1))
# 
# plot(MSE_boot_AIPW, type = "l", ylim = c(0, 1.2), ylab = "MSE")
# lines(MSE_boot_AIPW, col = 2)
# lines(MSE_boot_NIPW, col = 3)
# legend("topright", legend=c("OR", "AIPW", "NIPW"),
#        fill = c("black", 2,3) )


# 
# 
# plot(1:41, tau_hat_NIPW, lwd = 2, type = "l", ylim = c(0, 3), ylab = "tau")
# for (i in seq(1, 100, 10)) {
#   lines(tau_boot_NIPW[i, ], lwd = 2, col = 3, lty = "dashed") # 13, 16, 17, 21, 25
# 
# }
...
# 
# 
# # plot(1:41, tau_hat_OR, lwd = 2, type = "l", ylim = c(0, 3), ylab = "tau")
# for (i in seq(1, 100, 10)) {
#   lines(tau_boot_OR[i, ], lwd = 2, col = 3, lty = "dashed") # 13, 16, 17, 21, 25
# 
# }
# legend("topright", legend = c("true", "OR"),  fill = c(1, 3), bty = "n", cex = 1.4)

# 
# plot(1:41, tau_hat_AIPW, lwd = 2, type = "l", ylim = c(0, 3), ylab = "tau")
# for (i in seq(1, 100, 10)) {
#   lines(tau_boot_AIPW[i, ], lwd = 2, col = 3, lty = "dashed") # 13, 16, 17, 21, 25
# 
# }
# legend("topright", legend = c("true", "OR"),  fill = c(1, 3), bty = "n", cex = 1.4)
# 
...
outputName = paste("nb1d_nc_csda_bg_", SN, ".RData", sep = "")
